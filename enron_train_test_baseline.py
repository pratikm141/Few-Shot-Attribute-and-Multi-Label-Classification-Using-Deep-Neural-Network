...
directory = './results/enron/base{}shot'.format(args.shot)
...
# Train on first 25 labels and test on rest

print("Phase 1 starts----------Train on first 25 labels and test on rest---------")
...
path =  './results/enron/base{}shot/enron_first_{}.torch'.format(args.shot,epoch)
...
path =  './results/enron/base{}shot/enron_last_{}.torch'.format(args.shot,epoch)
torch.save(model.state_dict(), path)
