...
directory = './results/emotions/FSML{}shot'.format(args.shot)
...
path =  './results/emotions/FSML{}shot/emotions_first_{}.torch'.format(args.shot,epoch)
...
path =  './results/emotions/FSML{}shot/emotions_last_{}.torch'.format(args.shot,epoch)
torch.save(model.state_dict(), path)
