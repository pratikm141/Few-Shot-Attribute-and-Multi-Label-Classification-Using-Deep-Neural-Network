...
path =  './results/birds/FSML{}shot/birds_first_{}.torch'.format(args.shot,epoch)
torch.save(model.state_dict(), path)

# Train on last 10 labels and test on the first 9 labels

print("Phase 2 starts----------Train on first 9 labels and test on rest---------")
...
path =  './results/birds/FSML{}shot/birds_last_{}.torch'.format(args.shot,epoch)
torch.save(model.state_dict(), path)
