...
directory = './results/scene/base{}shot'.format(args.shot)
if not os.path.exists(directory):
    os.makedirs(directory)

import pickle

tensorFeat=pickle.load(open("./data/scene/sceneFeat.pkl","rb"))
tensorLabel=pickle.load(open("./data/scene/sceneLabel.pkl","rb"))
...
path =  './results/scene/base{}shot/scene_first_{}.torch'.format(args.shot,epoch)
torch.save(model.state_dict(), path)

# Train on last 3 labels and test on the first 3 labels

print("Phase 2 starts----------Train on last 3 labels and test on rest---------")
...
path =  './results/scene/base{}shot/scene_last_{}.torch'.format(args.shot,epoch)
torch.save(model.state_dict(), path)
