...
directory = './results/medical/FSML{}shot'.format(args.shot)
...
path =  './results/medical/FSML{}shot/medical_first_{}.torch'.format(args.shot,epoch)
...
path =  './results/medical/FSML{}shot/medical_last_{}.torch'.format(args.shot,epoch)
torch.save(model.state_dict(), path)
