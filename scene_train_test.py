...
directory = './results/scene/FSML{}shot'.format(args.shot)
...
path =  './results/scene/FSML{}shot/scene_first_{}.torch'.format(args.shot,epoch)
...
path =  './results/scene/FSML{}shot/scene_last_{}.torch'.format(args.shot,epoch)
torch.save(model.state_dict(), path)
