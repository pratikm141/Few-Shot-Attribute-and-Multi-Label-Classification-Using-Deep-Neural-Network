...
directory = './results/llog/base{}shot'.format(args.shot)
...
path =  './results/llog/base{}shot/llog_first_{}.torch'.format(args.shot,epoch)
...
path =  './results/llog/base{}shot/llog_last_{}.torch'.format(args.shot,epoch)
torch.save(model.state_dict(), path)
