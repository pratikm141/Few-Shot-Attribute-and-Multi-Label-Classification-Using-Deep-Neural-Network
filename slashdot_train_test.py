...
directory = './results/slashdot/FSML{}shot'.format(args.shot)
...
path =  './results/slashdot/FSML{}shot/slashdot_first_{}.torch'.format(args.shot,epoch)
...
path =  './results/slashdot/FSML{}shot/slashdot_last_{}.torch'.format(args.shot,epoch)
torch.save(model.state_dict(), path)
