...
directory = './results/yeast/FSML{}shot'.format(args.shot)
...
path =  './results/yeast/FSML{}shot/yeast_first_{}.torch'.format(args.shot,epoch)
torch.save(model.state_dict(), path)

# Train on last 7 labels and test on the first 7 labels
...
path =  './results/yeast/FSML{}shot/yeast_last_{}.torch'.format(args.shot,epoch)
torch.save(model.state_dict(), path)
