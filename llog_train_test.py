...
directory = './results/llog/FSML{}shot'.format(args.shot)
if not os.path.exists(directory):
    os.makedirs(directory)

import pickle

tensorFeat=pickle.load(open("./data/llog/llogFeat.pkl","rb"))
tensorLabel=pickle.load(open("./data/llog/llogLabel.pkl","rb"))
...
# Phase 1 - train on first 35 labels and test on the remaining 40
# Phase 2 - train on last 40 labels and test on the first 35

print("Training will be done twice")
print("Phase 1 - train from scratch on first 35 labels and test on the remaining 40")
print("Phase 2 - train from scratch on last 40 labels and test on the first 35")




# Train on first 35 label and test on rest

print("Phase 1 starts----------Train on first 35 label and test on rest---------")
...
path =  './results/llog/FSML{}shot/llog_first_{}.torch'.format(args.shot,epoch)
torch.save(model.state_dict(), path)

# Train on last 40 labels and test on the first 35 labels

print("Phase 2 starts----------Train on last 40 labels and test on rest---------")
...
path =  './results/llog/FSML{}shot/llog_last_{}.torch'.format(args.shot,epoch)
torch.save(model.state_dict(), path)
