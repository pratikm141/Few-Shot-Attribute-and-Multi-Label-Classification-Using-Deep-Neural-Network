...
directory = './results/medical/base{}shot'.format(args.shot)
if not os.path.exists(directory):
    os.makedirs(directory)

import pickle

tensorFeat=pickle.load(open("./data/medical/medicalFeat.pkl","rb"))
tensorLabel=pickle.load(open("./data/medical/medicalLabel.pkl","rb"))
...
# Phase 1 - train on first 22 labels and test on the remaining 23
# Phase 2 - train on last 23 labels and test on the first 22

print("Training will be done twice")
print("Phase 1 - train from scratch on first 22 labels and test on the remaining 23")
print("Phase 2 - train from scratch on last 23 labels and test on the first 22")




# Train on first 22 label and test on rest

print("Phase 1 starts----------Train on first 22 label and test on rest---------")
...
path =  './results/medical/base{}shot/medical_first_{}.torch'.format(args.shot,epoch)
torch.save(model.state_dict(), path)

# Train on last 23 labels and test on the first 22 labels

print("Phase 2 starts----------Train on last 23 labels and test on rest---------")
...
path =  './results/medical/base{}shot/medical_last_{}.torch'.format(args.shot,epoch)
torch.save(model.state_dict(), path)
