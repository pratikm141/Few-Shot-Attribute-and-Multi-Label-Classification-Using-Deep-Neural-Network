...
directory = './results/celeba/FSML{}shot'.format(args.shot)
...
path =  './results/celeba/FSML{}shot/celeba_first_{}.torch'.format(args.shot,epoch)
...
path =  './results/celeba/FSML{}shot/celeba_last_{}.torch'.format(args.shot,epoch)
torch.save(modelresnet50.state_dict(), path)
